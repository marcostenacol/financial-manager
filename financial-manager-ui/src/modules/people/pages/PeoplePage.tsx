  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
        <div>
          <h1 className="ledger-title text-2xl text-app-ink">{t('people.title')}</h1>
      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-56 bg-app-surface border border-app-border rounded-2xl animate-pulse" />
          ))}
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {visiblePeople.map((person) => {
              ...
              return (
                <motion.div
                  ...
                  className="ledger-item bg-app-surface border border-app-border p-6 rounded-2xl shadow-app-card cursor-pointer hover:border-app-accent/50 transition-all"
                >
