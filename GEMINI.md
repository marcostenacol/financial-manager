...
Este documento é a instrução mestre para qualquer planejamento, criação ou refatoração de código neste ecossistema. **O cumprimento destas diretrizes é obrigatório para todos os agentes de.**
